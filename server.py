...
import  my_enc_decrp as ENC_DECR
clients = []
...
def handling_client(cl_sock, addr):
        ...
        while True:
            try:
                ...
                message = ENC_DECR.aes_decrypt(message, secret_key).decode()
                ...
                if cmd == "LIST": file_name = ENC_DECR.aes_decrypt(file_response, secret_key).decode()
